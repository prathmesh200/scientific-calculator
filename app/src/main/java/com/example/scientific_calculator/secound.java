    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(secound.this,MainActivity.class);
        ...
        return new Object() {
            ...
            double parseFactor() {
                ...
                if (eat('(')) { // parentheses
                    ...
                    else if (func.equals("sin-1")) x = Math.asin(Math.toRadians(x));
                    else if (func.equals("cos")) x = Math.asin(Math.toRadians(x));
